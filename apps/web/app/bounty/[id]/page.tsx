...
import { ArrowLeft, Calendar, Coins, GitPullRequest, Users, ExternalLink, CheckCircle } from "lucide-react";
    ...
    <main className="relative isolate min-h-dvh">
      ...
      <div className="mx-auto max-w-3xl px-4 pb-24 pt-6 md:pt-10">
        ...
        <div className="rounded-2xl border border-border bg-card/80 p-6 md:p-8 backdrop-blur">
          ...
          <h1 className="mt-4 text-2xl font-bold tracking-tight md:text-3xl">Bounty #{id}</h1>
          <p className="mt-2 text-muted leading-relaxed">Complete this task to earn rewards. Submit your PR to claim.</p>

          <div className="mt-6 grid gap-3 text-sm text-muted md:grid-cols-2">
            <div className="flex items-center gap-2"><Coins className="h-4 w-4" /> <span className="font-medium text-foreground">1 CELO</span> reward</div>
            <div className="flex items-center gap-2"><Calendar className="h-4 w-4" /> 7 days remaining</div>
            <div className="flex items-center gap-2"><Users className="h-4 w-4" /> 0 / 3 slots claimed</div>
            <div className="flex items-center gap-2"><GitPullRequest className="h-4 w-4" /> Submit PR to claim</div>
          </div>

          <div className="mt-8 flex flex-wrap gap-3">
            <Button className="gap-2"><GitPullRequest className="h-4 w-4" /> Claim & Submit</Button>
          ...
          <div className="mt-8 rounded-xl border border-border/50 bg-muted/30 p-4">
            <h3 className="flex items-center gap-2 text-sm font-semibold"><CheckCircle className="h-4 w-4 text-emerald-500" /> How to claim</h3>
            <ol className="mt-2 list-decimal pl-5 text-sm text-muted space-y-1">
              <li>Fork the repository</li>
              <li>Complete the task requirements</li>
              <li>Submit a Pull Request</li>
              <li>Paste your PR URL in the claim form below</li>
            </ol>
          </div>
        </div>
      </div>
