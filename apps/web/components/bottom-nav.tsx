...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-border bg-background/92 pt-2 shadow-[0_-16px_40px_-24px_rgba(15,23,42,0.55)] backdrop-blur-xl md:hidden"
      style={{
